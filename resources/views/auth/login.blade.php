@extends('layouts.app', ['class' => 'login-page', 'page' => 'Sales & Inventory Management System', 'contentClass' => 'login-page', 'section' => 'auth'])

@section('content')
    <div class="col-lg-4 col-md-6 ml-auto mr-auto" style="background-color: black">
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-black">
                <div class="card-header">
                    ...
                    <img src="{{ asset('assets') }}/img/adminlogin.png" alt="" style="margin-bottom: 300px; width: 720px; height: 120px">
                    <br></br>
                ...
                <div class="card-footer">
                    <button type="submit" href="" class="btn btn-success btn-lg btn-block mb-3">Log in</button>
                    <div class="pull-left">
                        <h6>
